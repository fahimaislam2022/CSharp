...
namespace SuperMArketManagementSystem_BuyNix_
{
    public partial class Gadgets : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string insertcmd = "INSERT INTO gadgets (Product_ID, Gadget_name, Design, Color, Date, Price) VALUES (@Product_ID, @Gadget_name, @Design, @Color, @Date, @Price)";
                    ...
                    cmd.Parameters.AddWithValue("@Gadget_name", textBox2.Text);
                ...
                catch (Exception ex)
                {
                    ...
                    MessageBox.Show("This ID has already been taken.");
        ...
        void Binddata()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM gadgets", conn);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Insert all the information Correctly!");
            ...
            else
            {
                ...
                try
                {
                    ...
                    string updatecmd = "UPDATE gadgets SET Gadget_name = @Gadget_name, Design = @Design, Color = @Color, Date = @Date , Price=@Price WHERE Product_ID = @Product_ID";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (MessageBox.Show("Are you sure you want to delete?", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    string deletecmd = "DELETE FROM gadgets WHERE Product_ID = @Product_ID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string searchcmd = "SELECT * FROM gadgets WHERE Product_ID = @Product_ID";
